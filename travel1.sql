...
CREATE TABLE IF NOT EXISTS `banners` (
  ...
  CONSTRAINT `FK_banners_tours` FOREIGN KEY (`tour_id`) REFERENCES `tours` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Dumping data for table db_marketing_tour.banners: ~2 rows (approximately)
DELETE FROM `banners`;
INSERT INTO `banners` (`id`, `tour_id`, `title`, `image_url`, `target_link`, `position`, `is_active`, `created_at`, `updated_at`) VALUES
	(6, 11, 'Nghỉ dưỡng Phú Quốc - Khám phá Hòn Thơm Nature Park', '/uploads/banners/banner-1774353808304-416172882.webp', '/tours/nghi-duong-phu-quoc-hon-thom2', 'hero', 0, '2026-03-24 12:03:28', '2026-04-01 11:55:30'),
	(7, 2, 'Nghỉ dưỡng Phú Quốc - Khám phá Hòn Thơm Nature Park', '/uploads/banners/banner-1775044499284-385852132.jpg', '/tours/nghi-duong-phu-quoc-hon-thom', 'hero', 1, '2026-04-01 11:54:59', '2026-04-01 11:54:59');
...
-- Dumping data for table db_marketing_tour.booking_options: ~1 rows (approximately)
DELETE FROM `booking_options`;
INSERT INTO `booking_options` (`id`, `booking_id`, `option_name`, `price`, `quantity`, `total`) VALUES
	(2, 22, 'Leo Fansipan', 800000.00, 1, 800000.00);
...
CREATE TABLE IF NOT EXISTS `bookings` (
  ...
  CONSTRAINT `fk_bookings_pickup` FOREIGN KEY (`pickup_location_id`) REFERENCES `tour_pickup_locations` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Dumping data for table db_marketing_tour.bookings: ~20 rows (approximately)
DELETE FROM `bookings`;
INSERT INTO `bookings` (`id`, `user_id`, `tour_id`, `departure_id`, `pickup_location_id`, `booking_code`, `customer_name`, `customer_email`, `customer_phone`, `adult_qty`, `child_qty`, `infant_qty`, `customer_note`, `status`, `total_price`, `admin_note`, `created_at`, `updated_at`) VALUES
	(1, 2, 1, 1, 1, 'BK001', 'Nguyễn Văn A', 'a@gmail.com', '0911111111', 2, 1, 0, NULL, 'approved', 9500000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(2, 3, 2, 3, 3, 'BK002', 'Trần Thị B', 'b@gmail.com', '0922222222', 1, 0, 0, NULL, 'pending', 5500000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(3, 2, 3, 5, 5, 'BK003', 'Lê Văn C', 'c@gmail.com', '0933333333', 2, 0, 1, NULL, 'approved', 9600000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(4, 3, 4, 7, 7, 'BK004', 'Phạm Thị D', 'd@gmail.com', '0944444444', 1, 1, 0, NULL, 'contacted', 9000000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(5, 2, 5, 9, 8, 'BK005', 'Hoàng Văn E', 'e@gmail.com', '0955555555', 3, 0, 0, NULL, 'approved', 14400000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(6, 3, 6, 11, 9, 'BK006', 'Đỗ Văn F', 'f@gmail.com', '0966666666', 2, 1, 0, NULL, 'pending', 9800000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(8, 3, 8, 15, 11, 'BK008', 'Trần H', 'h@gmail.com', '0988888888', 2, 0, 0, NULL, 'approved', 7000000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(9, 2, 9, 17, 12, 'BK009', 'Lê I', 'i@gmail.com', '0999999999', 1, 1, 0, NULL, 'pending', 6400000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(10, 3, 10, 18, 13, 'BK010', 'Phạm K', 'k@gmail.com', '0900000000', 2, 0, 0, NULL, 'approved', 11600000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(11, 2, 11, 19, 14, 'BK011', 'Hoàng L', 'l@gmail.com', '0910000000', 2, 1, 0, NULL, 'approved', 13500000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(12, 3, 1, 2, 2, 'BK012', 'User12', 'u12@gmail.com', '0911111122', 1, 0, 0, NULL, 'pending', 3600000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(13, 2, 2, 4, 4, 'BK013', 'User13', 'u13@gmail.com', '0911111133', 2, 0, 0, NULL, 'approved', 11400000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(14, 3, 3, 6, 6, 'BK014', 'User14', 'u14@gmail.com', '0911111144', 1, 1, 0, NULL, 'approved', 7900000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(15, 2, 4, 8, 7, 'BK015', 'User15', 'u15@gmail.com', '0911111155', 1, 0, 0, NULL, 'cancelled', 7000000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(16, 3, 5, 10, 8, 'BK016', 'User16', 'u16@gmail.com', '0911111166', 2, 1, 0, NULL, 'approved', 12000000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(17, 2, 6, 12, 9, 'BK017', 'User17', 'u17@gmail.com', '0911111177', 2, 0, 0, NULL, 'approved', 9000000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(18, 3, 7, 14, 10, 'BK018', 'User18', 'u18@gmail.com', '0911111188', 1, 0, 0, NULL, 'pending', 8200000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(19, 2, 8, 16, 11, 'BK019', 'User19', 'u19@gmail.com', '0911111199', 3, 0, 0, NULL, 'approved', 10800000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(20, 3, 9, 17, 12, 'BK020', 'User20', 'u20@gmail.com', '0911111200', 2, 1, 0, NULL, 'approved', 9100000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
	(22, 7, 8, 15, NULL, 'BKMNJ10E6Y102BB6', 'minhtuyen', 'minhtuyenk201@gmail.com', '0867549067', 1, 0, 0, NULL, 'pending', 4300000.00, NULL, '2026-04-03 14:55:59', '2026-04-03 14:55:59');
...
CREATE TABLE IF NOT EXISTS `tour_departures` (
  ...
  PRIMARY KEY (`id`),
  KEY `tour_id` (`tour_id`),
  CONSTRAINT `fk_departures_tours` FOREIGN KEY (`tour_id`) REFERENCES `tours` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Dumping data for table db_marketing_tour.tour_departures: ~22 rows (approximately)
...
INSERT INTO `tour_departures` (`id`, `tour_id`, `departure_date`, `price_adult`, `price_child`, `price_infant`, `available_seats`, `status`) VALUES
	...
	(3, 2, '2026-05-03', 5500000.00, 4000000.00, 800000.00, 25, 'open'),
	...
	(20, 11, '2026-06-25', 6200000.00, 4700000.00, 900000.00, 5, 'open'),
	(21, 13, '2026-04-03', 24999999.00, 1000000.00, 500000.00, 10, 'open'),
	(22, 13, '2026-04-10', 400000000.00, 2000000.00, 400000.00, 20, 'open');
...
INSERT INTO `tour_images` (`id`, `tour_id`, `image_url`, `sort_order`) VALUES
	(1, 1, '/uploads/tours/tour-1775131548290-719880478.webp', 1),
	(2, 1, '/uploads/tours/tour-1775131548290-719880478.webp', 2),
	(3, 2, '/uploads/tours/tour-1775131548290-719880478.webp', 1),
	(4, 2, '/uploads/tours/tour-1775131548290-719880478.webp', 2),
	(5, 3, '/uploads/tours/tour-1775131548290-719880478.webp', 1),
	(6, 3, '/uploads/tours/tour-1775131548290-719880478.webp', 2),
	(7, 4, '/uploads/tours/tour-1775131548290-719880478.webp', 1),
	(8, 4, '/uploads/tours/tour-1775131548290-719880478.webp', 2),
	(9, 5, '/uploads/tours/tour-1775131548290-719880478.webp', 1),
	(10, 5, '/uploads/tours/tour-1775131548290-719880478.webp', 2),
	(11, 6, '/uploads/tours/tour-1775131548290-719880478.webp', 1),
	(12, 6, '/uploads/tours/tour-1775131548290-719880478.webp', 2),
	(13, 7, '/uploads/tours/tour-1775131548290-719880478.webp', 1),
	(14, 7, '/uploads/tours/tour-1775131548290-719880478.webp', 2),
	(15, 8, '/uploads/tours/tour-1775131548290-719880478.webp', 1),
	(16, 8, '/uploads/tours/tour-1775131548290-719880478.webp', 2),
	(17, 9, '/uploads/tours/tour-1775131548290-719880478.webp', 1),
	(18, 10, '/uploads/tours/tour-1775131548290-719880478.webp', 1),
	(19, 11, '/uploads/tours/tour-1775131548290-719880478.webp', 1),
	(20, 11, '/uploads/tours/tour-1775131548290-719880478.webp', 2),
	(21, 13, '/uploads/tours/tour-1775131548290-719880478.webp', 0),
	(22, 13, '/uploads/tours/tour-1775131548291-364593504.jpg', 1),
	(23, 13, '/uploads/tours/tour-1775131548293-605654298.webp', 2),
	(24, 13, '/uploads/tours/tour-1775131548294-356182172.webp', 3),
	(25, 13, '/uploads/tours/tour-1775131548295-428411922.webp', 4);
...
CREATE TABLE IF NOT EXISTS `tour_itineraries` (
  ...
  PRIMARY KEY (`id`),
  KEY `tour_id` (`tour_id`),
  CONSTRAINT `fk_itineraries_tours` FOREIGN KEY (`tour_id`) REFERENCES `tours` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Dumping data for table db_marketing_tour.tour_itineraries: ~23 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tour_options` (
  ...
  PRIMARY KEY (`id`),
  KEY `tour_id` (`tour_id`),
  CONSTRAINT `fk_options_tours` FOREIGN KEY (`tour_id`) REFERENCES `tours` (`id`) ON DELETE CASCADE
...
INSERT INTO `tour_options` (`id`, `tour_id`, `option_name`, `price`, `charge_type`) VALUES
	...
	(21, 13, 'Phòng đôi', 1000000.00, 'per_person');
...
CREATE TABLE IF NOT EXISTS `tour_pickup_locations` (
  ...
  PRIMARY KEY (`id`),
  KEY `tour_id` (`tour_id`),
  CONSTRAINT `fk_pickup_tours` FOREIGN KEY (`tour_id`) REFERENCES `tours` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- Dumping data for table db_marketing_tour.tour_pickup_locations: ~22 rows (approximately)
...
INSERT INTO `tour_pickup_locations` (`id`, `tour_id`, `location_name`, `pickup_time`, `surcharge_amount`) VALUES
	...
	(21, 13, 'Hà Nội', '19:05:00', 0.00),
	(22, 13, 'Bắc Giang', '21:05:00', 200000.00);
...
CREATE TABLE IF NOT EXISTS `tours` (
  ...
  `tour_badge` enum('featured','promotion','none') DEFAULT 'none' COMMENT 'loại tour khuyến mãi, nổi bật, bình thường',
...
-- Dumping data for table db_marketing_tour.tours: ~12 rows (approximately)
DELETE FROM `tours`;
...
INSERT INTO `users` (`id`, `role_id`, `full_name`, `email`, `password`, `phone_number`, `avatar_url`, `is_active`, `last_login`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Quản Trị Viên', '1@gmail.com', '$2a$12$9PTNubZ9YiqLA0fE4dKvROIcct3pSzRG0JZx7UVL8y9lhVQBJeDw.', '0901234567', '/uploads/avatars/avatar-1-1774261565350-737873517.jpg', 1, '2026-04-01 09:10:10', '2026-03-02 02:21:46', '2026-04-01 09:10:10'),
...
CREATE TABLE IF NOT EXISTS `votes` (
  ...
  `customer_email` varchar(150) NOT NULL COMMENT 'địa chỉ email',
  `rating` int(11) NOT NULL COMMENT 'giá trị đánh giá',
  `comment` text DEFAULT NULL,
  `is_approved` tinyint(4) DEFAULT 0 COMMENT 'chấp nhận cho hiển thị',
...
-- Dumping data for table db_marketing_tour.votes: ~20 rows (approximately)
DELETE FROM `votes`;
INSERT INTO `votes` (`id`, `tour_id`, `customer_name`, `customer_email`, `rating`, `comment`, `is_approved`, `created_at`) VALUES
	(1, 1, 'A', 'a@mail.com', 5, 'Rất tốt', 1, '2026-04-02 18:56:57'),
	(2, 2, 'B', 'b@mail.com', 4, 'Ổn áp', 1, '2026-04-02 18:56:57'),
	(3, 3, 'C', 'c@mail.com', 5, 'Tuyệt vời', 1, '2026-04-02 18:56:57'),
	(4, 4, 'D', 'd@mail.com', 3, 'Bình thường', 1, '2026-04-02 18:56:57'),
	(5, 5, 'E', 'e@mail.com', 5, 'Rất đáng tiền', 1, '2026-04-02 18:56:57'),
	(6, 6, 'F', 'f@mail.com', 4, 'Ok', 1, '2026-04-02 18:56:57'),
	(7, 7, 'G', 'g@mail.com', 5, 'Xuất sắc', 1, '2026-04-02 18:56:57'),
	(8, 8, 'H', 'h@mail.com', 4, 'Tốt', 1, '2026-04-02 18:56:57'),
	(9, 9, 'I', 'i@mail.com', 3, 'Tạm', 1, '2026-04-02 18:56:57'),
	(10, 10, 'K', 'k@mail.com', 5, 'Đỉnh', 1, '2026-04-02 18:56:57'),
	(11, 11, 'L', 'l@mail.com', 4, 'Hài lòng', 1, '2026-04-02 18:56:57'),
	(12, 1, 'M', 'm@mail.com', 5, 'Rất đẹp', 1, '2026-04-02 18:56:57'),
	(13, 2, 'N', 'n@mail.com', 4, 'Được', 1, '2026-04-02 18:56:57'),
	(14, 3, 'O', 'o@mail.com', 5, 'Rất ok', 1, '2026-04-02 18:56:57'),
	(15, 4, 'P', 'p@mail.com', 3, 'Chấp nhận', 1, '2026-04-02 18:56:57'),
	(16, 5, 'Q', 'q@mail.com', 5, 'Best', 1, '2026-04-02 18:56:57'),
	(17, 6, 'R', 'r@mail.com', 4, 'Nice', 1, '2026-04-02 18:56:57'),
	(18, 7, 'S', 's@mail.com', 5, 'Good', 1, '2026-04-02 18:56:57'),
	(19, 8, 'T', 't@mail.com', 4, 'Ổn', 1, '2026-04-02 18:56:57'),
	(20, 9, 'U', 'u@mail.com', 3, 'Trung bình', 1, '2026-04-02 18:56:57');
