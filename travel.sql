...
INSERT INTO `banners` (`id`, `tour_id`, `title`, `image_url`, `target_link`, `position`, `is_active`, `created_at`, `updated_at`) VALUES
	(6, 11, 'Nghỉ dưỡng Phú Quốc - Khám phá Hòn Thơm Nature Park', '', '/tours/nghi-duong-phu-quoc-hon-thom2', 'hero', 0, '2026-03-24 12:03:28', '2026-04-27 14:18:57'),
...
CREATE TABLE IF NOT EXISTS `bookings` (
  ...
  CONSTRAINT `bk_depa` FOREIGN KEY (`departure_id`) REFERENCES `tour_departures` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `bookings` (`id`, `user_id`, `tour_id`, `departure_id`, `pickup_location_id`, `booking_code`, `customer_name`, `customer_email`, `customer_phone`, `adult_qty`, `child_qty`, `infant_qty`, `customer_note`, `status`, `total_price`, `admin_note`, `created_at`, `updated_at`) VALUES
	(1, 2, 1, 1, 1, 'BK001', 'Nguyễn Văn A', 'a@gmail.com', '0911111111', 2, 1, 0, NULL, 'approved', 9500000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(2, 3, 2, 3, 3, 'BK002', 'Trần Thị B', 'b@gmail.com', '0922222222', 1, 0, 0, NULL, 'pending', 5500000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(3, 2, 3, 5, 5, 'BK003', 'Lê Văn C', 'c@gmail.com', '0933333333', 2, 0, 1, NULL, 'approved', 9600000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(4, 3, 4, 7, 7, 'BK004', 'Phạm Thị D', 'd@gmail.com', '0944444444', 1, 1, 0, NULL, 'contacted', 9000000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(5, 2, 5, 9, 8, 'BK005', 'Hoàng Văn E', 'e@gmail.com', '0955555555', 3, 0, 0, NULL, 'approved', 14400000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(6, 3, 6, 11, 9, 'BK006', 'Đỗ Văn F', 'f@gmail.com', '0966666666', 2, 1, 0, NULL, 'pending', 9800000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(8, 3, 8, 15, 11, 'BK008', 'Trần H', 'h@gmail.com', '0988888888', 2, 0, 0, NULL, 'approved', 7000000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(9, 2, 9, 17, 12, 'BK009', 'Lê I', 'i@gmail.com', '0999999999', 1, 1, 0, NULL, 'pending', 6400000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(10, 3, 10, 18, 13, 'BK010', 'Phạm K', 'k@gmail.com', '0900000000', 2, 0, 0, NULL, 'approved', 11600000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(11, 2, 11, 19, 14, 'BK011', 'Hoàng L', 'l@gmail.com', '0910000000', 2, 1, 0, NULL, 'approved', 13500000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(12, 3, 1, 2, 2, 'BK012', 'User12', 'u12@gmail.com', '0911111122', 1, 0, 0, NULL, 'pending', 3600000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(13, 2, 2, 4, 4, 'BK013', 'User13', 'u13@gmail.com', '0911111133', 2, 0, 0, NULL, 'approved', 11400000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(14, 3, 3, 6, 6, 'BK014', 'User14', 'u14@gmail.com', '0911111144', 1, 1, 0, NULL, 'approved', 7900000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(15, 2, 4, 8, 7, 'BK015', 'User15', 'u15@gmail.com', '0911111155', 1, 0, 0, NULL, 'cancelled', 7000000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(16, 3, 5, 10, 8, 'BK016', 'User16', 'u16@gmail.com', '0911111166', 2, 1, 0, NULL, 'approved', 12000000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(17, 2, 6, 12, 9, 'BK017', 'User17', 'u17@gmail.com', '0911111177', 2, 0, 0, NULL, 'approved', 9000000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(18, 3, 7, 14, 10, 'BK018', 'User18', 'u18@gmail.com', '0911111188', 1, 0, 0, NULL, 'pending', 8200000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(19, 2, 8, 16, 11, 'BK019', 'User19', 'u19@gmail.com', '0911111199', 3, 0, 0, NULL, 'approved', 10800000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(20, 3, 9, 17, 12, 'BK020', 'User20', 'u20@gmail.com', '0911111200', 2, 1, 0, NULL, 'approved', 9100000.00, NULL, '2026-04-02 18:56:51', '2026-04-02 18:56:51'),
	(23, 7, 10, 18, 13, 'BKMOH0MID52C0FB6', 'minhtuyen', 'minhtuyenk201@gmail.com', '0000000000', 1, 0, 0, NULL, 'approved', 6800000.00, NULL, '2026-04-27 16:49:21', '2026-04-27 16:49:21'),
	(24, 7, 7, 13, NULL, 'BKMOH101AS1BB547', 'minhtuyen', 'minhtuyenk201@gmail.com', '0000000000', 1, 0, 0, NULL, 'approved', 8000000.00, NULL, '2026-04-27 16:59:52', '2026-04-27 16:59:52'),
	(27, 7, 8, 15, 11, 'BKMOH6DVII2D0BAD', 'minhtuyen', 'minhtuyenk201@gmail.com', '0000000000', 1, 0, 0, 'aaaaaaaaa', 'approved', 3500000.00, NULL, '2026-04-27 19:30:36', '2026-04-27 19:30:36');
...
-- Dumping data for table db_marketing_tour.notifications: ~6 rows (approximately)
DELETE FROM `notifications`;
INSERT INTO `notifications` (`id`, `user_id`, `type`, `sender_name`, `message`, `related_id`, `related_slug`, `is_read`, `created_at`) VALUES
	(1, 7, 'booking', 'Hệ thống', 'bạn đã đặt thành công tour "Hành trình di sản: Đà Nẵng - Hội An - Bà Nà Hills". Vui lòng chờ nhân viên liên hệ xác nhận.', 24, NULL, 0, '2026-04-27 16:59:52'),
	(2, 7, 'booking', 'Hệ thống', 'đơn đặt tour "Hành trình di sản: Đà Nẵng - Hội An - Bà Nà Hills" của bạn đã được duyệt', 24, NULL, 0, '2026-04-27 17:00:07'),
	...
	(5, 7, 'booking', 'Hệ thống', 'bạn đã đặt thành công tour "Tour Khám Phá Sapa - Chinh Phục Đỉnh Fansipan". Vui lòng chờ nhân viên liên hệ xác nhận.', 27, 'tour-kham-pha-sapa-chinh-phuc-fansipan1', 0, '2026-04-27 19:30:36'),
	(6, 7, 'booking', 'Hệ thống', 'đơn đặt tour "Tour Khám Phá Sapa - Chinh Phục Đỉnh Fansipan" của bạn đã được duyệt', 27, NULL, 0, '2026-04-27 19:43:39');
...
CREATE TABLE IF NOT EXISTS `tours` (
  ...
  CONSTRAINT `fk_tour_category` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tours` (`id`, `category_id`, `title`, `slug`, `summary`, `highlights`, `price_includes`, `price_excludes`, `terms_and_notes`, `cancellation_policy`, `duration_days`, `duration_nights`, `thumbnail_url`, `tour_badge`, `status`) VALUES
	(1, 2, 'Tour Khám Phá Sapa - Chinh Phục Đỉnh Fansipan', 'tour-kham-pha-sapa-chinh-phuc-fansipan', 'Hành trình đến với thị trấn trong sương, khám phá bản Cát Cát và chinh phục nóc nhà Đông Dương.', NULL, NULL, NULL, NULL, NULL, 3, 2, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active'),
	(2, 1, 'Nghỉ dưỡng Phú Quốc - Khám phá Hòn Thơm Nature Park', 'nghi-duong-phu-quoc-hon-thom', 'Tận hưởng nắng vàng biển xanh tại đảo ngọc Phú Quốc, đi cáp treo vượt biển dài nhất thế giới.', NULL, NULL, NULL, NULL, NULL, 4, 3, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active'),
	(3, 1, 'Hành trình di sản: Đà Nẵng - Hội An - Bà Nà Hills', 'hanh-trinh-di-san-da-nang-hoi-an-ba-na', 'Tham quan các điểm đến nổi tiếng nhất miền Trung: Cầu Vàng, phố cổ Hội An, biển Mỹ Khê.', NULL, NULL, NULL, NULL, NULL, 4, 3, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active'),
	(4, 2, 'Hành trình di sản: Đà Nẵng - Hội An - Bà Nà Hills', 'hanh-trinh-di-san-da-nang-hoi-an-ba-na1', 'Tham quan các điểm đến nổi tiếng nhất miền Trung: Cầu Vàng, phố cổ Hội An, biển Mỹ Khê.', NULL, NULL, NULL, NULL, NULL, 4, 3, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active'),
	(5, 1, 'Hành trình di sản: Đà Nẵng - Hội An - Bà Nà Hills', 'hanh-trinh-di-san-da-nang-hoi-an-ba-na2', 'Tham quan các điểm đến nổi tiếng nhất miền Trung: Cầu Vàng, phố cổ Hội An, biển Mỹ Khê.', NULL, NULL, NULL, NULL, NULL, 4, 3, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active'),
	(6, 1, 'Hành trình di sản: Đà Nẵng - Hội An - Bà Nà Hills', 'hanh-trinh-di-san-da-nang-hoi-an-ba-na3', 'Tham quan các điểm đến nổi tiếng nhất miền Trung: Cầu Vàng, phố cổ Hội An, biển Mỹ Khê.', NULL, NULL, NULL, NULL, NULL, 4, 3, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active'),
	(7, 2, 'Hành trình di sản: Đà Nẵng - Hội An - Bà Nà Hills', 'hanh-trinh-di-san-da-nang-hoi-an-ba-na4', 'Tham quan các điểm đến nổi tiếng nhất miền Trung: Cầu Vàng, phố cổ Hội An, biển Mỹ Khê.', NULL, NULL, NULL, NULL, NULL, 4, 3, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active'),
	(8, 2, 'Tour Khám Phá Sapa - Chinh Phục Đỉnh Fansipan', 'tour-kham-pha-sapa-chinh-phuc-fansipan1', 'Hành trình đến với thị trấn trong sương, khám phá bản Cát Cát và chinh phục nóc nhà Đông Dương.', NULL, NULL, NULL, NULL, NULL, 3, 2, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active'),
	(9, 1, 'Tour Khám Phá Sapa - Chinh Phục Đỉnh Fansipan', 'tour-kham-pha-sapa-chinh-phuc-fansipan2', 'Hành trình đến với thị trấn trong sương, khám phá bản Cát Cát và chinh phục nóc nhà Đông Dương.', NULL, NULL, NULL, NULL, NULL, 3, 2, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active'),
	(10, 1, 'Nghỉ dưỡng Phú Quốc - Khám phá Hòn Thơm Nature Park', 'nghi-duong-phu-quoc-hon-thom1', 'Tận hưởng nắng vàng biển xanh tại đảo ngọc Phú Quốc, đi cáp treo vượt biển dài nhất thế giới.', NULL, NULL, NULL, NULL, NULL, 4, 3, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active'),
	(11, 1, 'Nghỉ dưỡng Phú Quốc - Khám phá Hòn Thơm Nature Park', 'nghi-duong-phu-quoc-hon-thom2', 'Tận hưởng nắng vàng biển xanh tại đảo ngọc Phú Quốc, đi cáp treo vượt biển dài nhất thế giới.', NULL, NULL, NULL, NULL, NULL, 4, 3, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active'),
	...
	(14, 1, 'tour sapa', 'tour-sapa', 'abc', '<p>abc</p>', '<p>abc</p>', '<p>abc</p>', '<p>abc</p>', '<p>abc</p>', 3, 2, '/uploads/tours/tour-1777299641824-589815401.jpg', 'featured', 'active');
...
CREATE TABLE IF NOT EXISTS `tour_departures` (
  ...
  PRIMARY KEY (`id`),
  KEY `tour_id` (`tour_id`),
  CONSTRAINT `tour_d` FOREIGN KEY (`tour_id`) REFERENCES `tours` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tour_departures` (`id`, `tour_id`, `departure_date`, `price_adult`, `price_child`, `price_infant`, `available_seats`, `status`) VALUES
	...
	(37, 14, '2026-04-28', 300000.00, 20000.00, 200000.00, 20, 'open');
...
-- Dumping data for table db_marketing_tour.tour_images: ~21 rows (approximately)
...
INSERT INTO `tour_images` (`id`, `tour_id`, `image_url`, `sort_order`) VALUES
	...
	(26, 14, '/uploads/tours/tour-1777299641824-589815401.jpg', 0);
...
-- Dumping data for table db_marketing_tour.tour_itineraries: ~24 rows (approximately)
...
INSERT INTO `tour_pickup_locations` (`id`, `tour_id`, `location_name`, `pickup_time`, `surcharge_amount`) VALUES
	...
	(41, 14, 'Hà nội', '22:07:00', 50000.00);
...
INSERT INTO `users` (`id`, `role_id`, `full_name`, `email`, `password`, `phone_number`, `avatar_url`, `is_active`, `last_login`, `created_at`, `updated_at`) VALUES
	(1, 1, 'Quản Trị Viên', '1@gmail.com', '$2a$12$9PTNubZ9YiqLA0fE4dKvROIcct3pSzRG0JZx7UVL8y9lhVQBJeDw.', '0901234567', '/uploads/avatars/avatar-1-1774261565350-737873517.jpg', 1, '2026-04-27 21:08:51', '2026-03-02 09:21:46', '2026-04-01 16:10:10'),
	(2, 2, 'Nguyễn Văn A', 'nguyenvana@gmail.com', '$2y$10$abcdefghijklmnopqrstuv', '0912345678', 'https://ui-avatars.com/api/?name=Nguyễn+A', 1, NULL, '2026-03-02 09:21:46', '2026-03-02 09:21:46'),
	(3, 2, 'Trần Thị B', 'tranthib@gmail.com', '$2y$10$abcdefghijklmnopqrstuv', '0987654321', 'https://ui-avatars.com/api/?name=Trần+B', 1, NULL, '2026-03-02 09:21:46', '2026-03-02 09:21:46'),
	(7, 1, 'minhtuyen', 'minhtuyenk201@gmail.com', '$2a$12$Y09FDK6TQQMzRhXtZRoMd.aST02Uc5/9TRbyptOph2AJe7YjBSwme', NULL, '/uploads/avatars/avatar-7-1777293312005-679122399.jpg', 1, '2026-04-27 19:58:21', '2026-03-11 22:11:21', '2026-04-27 19:35:12'),
	(8, 2, 'Cường Trần', 'tranhungcuong31720@gmail.com', '$2a$12$bSGnDGuQAEH13j0etNNGdubDzqePGknaRuCjktIrTZRYz27KkIree', '0978818244', NULL, 1, NULL, '2026-03-20 09:27:41', '2026-03-20 09:28:16');
...
INSERT INTO `votes` (`id`, `tour_id`, `customer_name`, `customer_email`, `rating`, `comment`, `is_approved`, `created_at`, `images`, `likes_count`, `admin_reply`, `admin_reply_at`, `parent_id`, `user_id`) VALUES
	...
	(8, 8, 'H', 'h@mail.com', 4, 'Tốt', 1, '2026-04-02 18:56:57', NULL, 0, NULL, NULL, NULL, NULL),
	...
	(19, 8, 'T', 't@mail.com', 4, 'Ổn', 1, '2026-04-02 18:56:57', NULL, 0, NULL, NULL, NULL, NULL),
	...
	(29, 2, 'Quản Trị Viên', '1@gmail.com', 5, 'abc', 1, '2026-04-27 21:11:38', NULL, 0, NULL, NULL, NULL, 1);
...
-- Dumping data for table db_marketing_tour.vote_likes: ~0 rows (approximately)
