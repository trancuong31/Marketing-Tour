...
-- Dumping data for table db_marketing_tour.tour_translations: ~19 rows (approximately)
...
INSERT INTO `tour_translations` (`id`, `tour_id`, `language`, `title`, `slug`, `summary`, `highlights`, `price_includes`, `price_excludes`, `terms_and_notes`, `cancellation_policy`) VALUES
	...
	(14, 1, 'en', 'Sapa Discovery Tour - Conquer Fansipan Peak 3', 'sapa-discovery-tour-conquer-fansipan-peak-3', 'Journey to the misty mountain town, explore Cat Cat village, and conquer the roof of Indochina.', NULL, NULL, NULL, NULL, NULL),
	(15, 1, 'zh', '沙巴探索之旅 - 征服番西邦峰 3', 'sha-ba-tan-suo-zhi-lv-zheng-fu-fan-xi-bang-feng-3', '前往云雾缭绕的山城，探索猫猫村，并征服印度支那屋脊。', NULL, NULL, NULL, NULL, NULL),
	(16, 8, 'en', 'Sapa Discovery Tour - Conquer Fansipan Peak 1', 'sapa-discovery-tour-conquer-fansipan-peak-1', 'Journey to the misty mountain town, explore Cat Cat village, and conquer the roof of Indochina.', NULL, NULL, NULL, NULL, NULL),
	(17, 8, 'zh', '沙巴探索之旅 - 征服番西邦峰 1', 'sha-ba-tan-suo-zhi-lv-zheng-fu-fan-xi-bang-feng-1', '前往云雾缭绕的山城，探索猫猫村，并征服印度支那屋脊。', NULL, NULL, NULL, NULL, NULL),
	(18, 9, 'en', 'Sapa Discovery Tour - Conquer Fansipan Peak 2', 'sapa-discovery-tour-conquer-fansipan-peak-2', 'Journey to the misty mountain town, explore Cat Cat village, and conquer the roof of Indochina.', NULL, NULL, NULL, NULL, NULL),
	(19, 9, 'zh', '沙巴探索之旅 - 征服番西邦峰 2', 'sha-ba-tan-suo-zhi-lv-zheng-fu-fan-xi-bang-feng-2', '前往云雾缭绕的山城，探索猫猫村，并征服印度支那屋脊。', NULL, NULL, NULL, NULL, NULL),
