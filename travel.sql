...
INSERT INTO `bookings` (`id`, `user_id`, `tour_id`, `departure_id`, `pickup_location_id`, `booking_code`, `customer_name`, `customer_email`, `customer_phone`, `adult_qty`, `child_qty`, `infant_qty`, `customer_note`, `status`, `total_price`, `admin_note`, `created_at`, `updated_at`) VALUES
	...
	(7, 2, 7, 13, 10, 'BK007', 'Nguyễn G', 'g@gmail.com', '0977777777', 1, 0, 0, NULL, 'approved', 8000000.00, NULL, '2026-04-02 11:56:51', '2026-04-02 11:56:51'),
...
-- Dumping data for table db_marketing_tour.booking_options: ~0 rows (approximately)
