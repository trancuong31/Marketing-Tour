...
//  */
// //fix Lỗi “gõ 1 chữ rồi mất focus phải click lại” trong code của bạn xảy ra vì:
...
// const OtpInput = ({ otpDigits, setOtpDigits, otpRefs, clearError }) => {
...
//     //     </div>
//     // ); root make out focus when input data
...
//     return (
//         <div className="fixed inset-0 z-50 flex items-center justify-center p-4"> //onClick={onClose} It's rootc make out form signin when click mouse outside
//             {/* Backdrop */}
